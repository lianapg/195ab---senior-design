...
def draw_lines(img, lines):
    ...
    #steer_angle = Kp * offset #ex 30 deg
    #print ("width = ", img.shape[1] // 2)
...
def process_image(img, img2):
    ...
    #vertices = np.array([[(0, imshape[0]), (0, imshape[0]*0.25), (imshape[1], imshape[0]*0.25), (imshape[1], imshape[0])]], dtype=np.int32)
